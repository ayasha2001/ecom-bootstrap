...
const AboutPage = () => {
  return (
    <div id="about" style={{ maxWidth: "900px" , margin:"auto"}}>
        <h1 style={{fontFamily:"Metal Mania", padding:"10px", display:"flex",justifyContent:"center"}}>About</h1>
      <div style={{ float: "left", margin: "20px 50px", borderRadius: "50%" }}>
        <img
